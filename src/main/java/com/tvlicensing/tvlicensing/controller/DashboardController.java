...
public class DashboardController {
    ...
    // Spring injects the repository and licence service automatically
    ...
    // GET /dashboard - loads the dashboard for the logged-in customer
    @GetMapping("/dashboard")
    public String dashboard(@AuthenticationPrincipal UserDetails userDetails,
                            @RequestParam(required = false) String licencePurchased,
